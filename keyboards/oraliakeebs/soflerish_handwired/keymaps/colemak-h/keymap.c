...
//  qmk compile -kb oraliakeebs/soflerish_handwired -km colemak-h
...
[0] = LAYOUT(
  ...
  SFT_T(KC_VOLU),  KC_A,   KC_R,    KC_S,    KC_T,    KC_G,                              KC_M,    KC_N,       KC_E,    KC_I,    KC_O,     KC_QUOT,
  CTL_T(KC_VOLD),  KC_Z,   KC_X,    KC_C,    KC_V,    KC_D,         KC_LBRC,   KC_RBRC,  KC_K,    KC_H,       KC_COMM, KC_DOT,  KC_SLSH,  KC_MINS,
